...
// MakeHTTPHandler mounts all the service endpoints into an http.Handler.
...
func MakeHTTPHandler(s Service, logger log.Logger) http.Handler {
	...
	r.Methods("DELETE").Methods("/profiles/{id}").Handler(httptransport.NewServer(
...
// trigger an endpoint (transport-level) error. For more information.
